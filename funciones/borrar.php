<?php
    ...
    try {
        // Eliminar registros de la tabla 'apuestas' donde 'user_id' coincide con el valor dado
        $stmt = $pdo->prepare("DELETE FROM apuestas WHERE user_id = ?");
        $stmt->execute([$from]);
        ...
        // Eliminar registros de la tabla 'usuarios' donde 'user_id' coincide con el valor dado
